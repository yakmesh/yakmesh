...
// Used to normalize .tgz uploads into the package.zip format the
// restart-time swap consumer expects.
// ---------------------------------------------------------------
const CRC_TABLE = (() => {
...
/**
 * Build a zip buffer from [{name, data}] entries (STORED — no compression).
 */
